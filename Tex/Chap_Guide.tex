...
\begin{figure}[!htbp]
    ...
    \includegraphics[trim = 15mm 5mm 5mm 24mm, clip, width=0.40\textwidth]{wps_show_dom}
...
\begin{figure}[!htbp]
    \centering
    %trim option's parameter order: left bottom right top
    \includegraphics[trim = 5mm 0mm 0mm 0mm, clip, width=0.40\textwidth]{UW-plt_SkewT}
